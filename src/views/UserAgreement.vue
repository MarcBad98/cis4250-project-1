<template>
  <div id="view-user-agreement">
    ...
    <p>
      ...
      conditions of your use of the ⚠️ [insert website name here] ⚠️ website
      ...
      you must not accept this Agreement and may not access and use the Website
      and Services. You acknowledge that this Agreement is a contract between

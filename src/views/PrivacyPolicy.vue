<template>
  <div id="view-privacy-policy">
    ...
    <p>
      ...
      information ("Personal Information") you may provide on the Whistlechain
      website ("Website" or "Service") and any of its related products and
      services (collectively, "Services") is collected, protected and used. It
      ...
      "your") and this Website operator ("Operator", "we", "us" or "our"). By
      ...
      Agreement. This Policy does not apply to the practices of companies that
